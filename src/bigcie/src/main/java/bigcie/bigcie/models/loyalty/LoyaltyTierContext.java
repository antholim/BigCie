...
public class LoyaltyTierContext {
    ...
    public LoyaltyTierContext(IUserService userService, IReservationLookup reservationLookup, ITripService tripService,
            LoyaltyTierFactory loyaltyTierFactory, INotificationService notificationService) {
